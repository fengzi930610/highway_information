...
class __CFG
{
    ...
    // CONST MYSQL = 'mysql://root:root@localhost:3306/animal/jh_/UTF8';
	CONST MYSQL = 'mysql://bdm695203465:Aa123456@bdm695203465.my3w.com:3306/bdm695203465_db/jh_/UTF8';
    ...
    CONST C_PREFIX  = 'KT-';
    CONST C_PATH    = '/';
    CONST C_DOMAIN  = 'http://www.86fff.vip';
    CONST C_EXPIRE  = 2592000;
    CONST C_SECURE  = true; //https
